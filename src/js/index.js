...
deviceTypeSummary.addEventListener("click", function() {
  ...
  let expandArrow = deviceTypeSummary.querySelectorAll(".expand-icon__expand-arrow");
...
let openModal = function(modalWindow, button, form, overlay) {
  ...
  mobileMenuContainer.setAttribute("style", "position: fixed;");
  pageContainer.setAttribute("style", "position: fixed;");
  overlay.setAttribute("style", "opacity: 0.9;");
  if (window.innerWidth < 768) {
    modalWindow.setAttribute("style", "position: fixed; visibility: visible; left: 0; z-index: 50;");
  } else if (window.innerWidth >= 768 && window.innerWidth < 1440) {
    modalWindow.setAttribute("style", "position: fixed; visibility: visible; left: 0; z-index: 50;");
    button.setAttribute("style", "transform: translate(-95px, 30px)");
  } else {
    let windowOversize = (window.innerWidth - 1440) / 2;
    modalWindow.setAttribute("style", "position: fixed; visibility: visible; left: " + windowOversize + "px; z-index: 50;");
    button.setAttribute("style", "transform: translate(-95px, 30px)");
  }
}

let hideModal = function(modalWindow, button, form, overlay) {
  mobileMenuContainer.removeAttribute("style", "position: fixed");
  pageContainer.removeAttribute("style", "position: fixed");
  form.setAttribute("style", "opacity: 0;");
  overlay.setAttribute("style", "opacity: 0;");
  if (window.innerWidth < 768) {
    modalWindow.setAttribute("style", "position: fixed; visibility: visible; left: 320px; z-index: 0;");
  } else if (window.innerWidth >= 768 && window.innerWidth < 1440) {
    modalWindow.setAttribute("style", "position: fixed; visibility: visible; left: 768px; z-index: 0;");
    button.setAttribute("style", "transform: translate(0, 30px)");
  } else {
    modalWindow.setAttribute("style", "position: fixed; visibility: visible; left: 1440px; z-index: 0;");
    button.setAttribute("style", "transform: translate(0, 30px)");
  }
}


let leaveRequest = function() {
  if (window.innerWidth < 1440) {
    let button = document.querySelector(".leave-request");
    return button;
  } else {
    let button = document.querySelectorAll(".leave-request");
    return button[button.length - 1];
  }
}
...
burgerMenu.addEventListener("click", function() {
  mobileMenuContainer.setAttribute("style", "margin-left: 0; box-shadow: 16px 0px 52px rgba(14, 24, 80, 0.2);");
  pageContainer.setAttribute("style", "position: fixed;");
  mobileMenuOverlay.setAttribute("style", "width: 448px; opacity: 0.9; left: 320px;");
...
let hideMobileMenu = function() {
  ...
  pageContainer.removeAttribute("style", "position: fixed;");
  mobileMenuOverlay.removeAttribute("style", "width: 448px; opacity: 0.9; left: 320px;");
}
